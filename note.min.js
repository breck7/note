...
Note.union=function(a){var b=Note.unionSingle(arguments[0],arguments[1]),c;for(c in arguments)if(1!==c&&(b=Note.unionSingle(b,arguments[c]),!b.length()))break;return b};Note.unionSingle=function(a,b){var c=new Note,d;for(d in a.names())a[d]instanceof Note&&(c[d]=a[d].union(b[d])),a[d]===b[d]&&(c[d]=a[d]);return c};Note.prototype.privates=[];Note.prototype.clear=function(){for(var a in this.names())delete this[a];return this};Note.prototype.clone=function(){return new Note(this)};
